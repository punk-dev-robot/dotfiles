...
-- FirefoxPWA web apps (PWAsForFirefox): class FFPWA-<site id>; ids in ~/.local/share/firefoxpwa/config.json
-- (`firefoxpwa site launch`). Profiles: Work (Meet, Linear), Personal (YouTube, X, WhatsApp, Reclaim).
local function pwa(key, name, site, opts)
  scratch(key, name, "FFPWA-" .. site, "firefoxpwa site launch " .. site, opts)
end
pwa("SUPER + SHIFT + BACKSPACE", "whatsapp", "01M2V2Q827W2W8M213NYZG6RQK")
pwa("SUPER + X", "x", "01M2V3PMGTH0K65YQDQ6WZK08T")
pwa("SUPER + Y", "youtube", "01M2V2Q7KTBK67FV2EPPB71X7F")
scratch("SUPER + SHIFT + V", "discord", "vesktop", "vesktop")
pwa("SUPER + V", "meet", "01M2TW5QXGJWY46NTDR6Z21WJG", { focus_on_activate = true })
...
pwa("SUPER + T", "linear", "01M2V2Q68ZJ85SFA5CY5V6Q5KW")
...
pwa("SUPER + DELETE", "reclaim", "01M2V2QPV4AAJK4864J81DCJKW")
