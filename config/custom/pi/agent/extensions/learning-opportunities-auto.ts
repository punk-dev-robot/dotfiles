/**
 * learning-opportunities-auto — pi-native port of the upstream
 * learning-opportunities-auto Claude Code PostToolUse hook
 * (https://github.com/DrCatHicks/learning-opportunities).
 *
 * Ported from vekexasia's extension (vekexasia/dotenv pi/agent/extensions/).
 *
 * Watches bash tool results for `git commit`; on the next agent turn it
 * injects a hidden nudge asking the model to consider offering a
 * learning-opportunities exercise. Max 2 offers per session, counter
 * resets on session start. Requires the learning-opportunities skill
 * (installed via tessl into ~/.agents/skills/tessl__learning-opportunities).
 */
